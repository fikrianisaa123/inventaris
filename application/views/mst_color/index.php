	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<h1>
				Jenis Peralatan
				<small>Show me your true </small>
			</h1>
			<ol class="breadcrumb">
				<li class="active"><i class="fa fa-tint"></i> &nbsp; Peralatan</li>
			</ol>
		</section>
		...
		<section class="content">
						...
						<form action="<?php echo base_url('color/add') ?>" method="post" autocomplete="off" class="form form-horizontal">
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('name')) {echo "has-error";} ?>">
									<input type="text" name="name" id="name" class="form-control" placeholder="Nama Peralatan" value="<?php echo set_value('name'); ?>" required>
								</div>
							</div>
							<div class="form-group">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">List of Peralatan
					</h3>
									...
									<td width="15%">
										<form action="<?php echo base_url('color/delete/'.$data->id) ?>" method="post" autocomplete="off">
											<div class="btn-group-horizontal">
												<a class="btn btn-sm btn-primary" href="<?php echo base_url('color/edit/'.$data->id) ?>" role="button"><i class="fa fa-pencil"></i> </a>
