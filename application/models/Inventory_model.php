...
class Inventory_model extends CI_Model
{
	function __construct()
	{
		...
		$this->inventaris_table = 'inventaris';
	...
	{
		return $this->db->get('master_color')->result_array();
	}
	...
	public function ubah_peralatan()
	{
		$data = array(
			'kategori' => $this->input->post('kategori'),
			'jenis_peralatan' => $this->input->post('jenisperalatan'),
	...
	public function hapus_peralatan($where)
	{
	...
	{
		return $this->db->get('inv_categories')->result_array();
	}

	public function detail_peralatan($kode)
	{
	...
	*/
	...
	{
		$this->db->select(
			$this->inventaris_table.".kategori, ".
			$this->categories_table.".code, ".
			$this->categories_table.".name, ".
			"COUNT(".$this->inventaris_table.".kategori) AS total"
		);
		$this->db->from($this->inventaris_table);
	...
	*/
	...
	{
		return $this->db->get('inv_status')->result_array();
	}	

	public function detailkategori($where)
	{
		$this->db->where('category_id', $where);
		return $this->db->get('inv_datas')->result_array();
	}
